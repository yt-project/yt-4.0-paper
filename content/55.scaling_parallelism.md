...
For example, when conducting halo finding and analysis (see @sec:halo-finding) yt can parallelize in groups of MPI tasks _across_ halos, and then decompose the work _within_ a given halo across MPI tasks inside that communicator.
