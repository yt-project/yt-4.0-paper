...
For instance, there may be a cell that spans $r$ from <span id="coordinate_info_r" style="font-family: monospace;">0.25 to 0.375</span> and 
$\theta$ from <span id="coordinate_info_theta" style="font-family: monospace;">30 to 45</span>, which is defined by the array values defined in cell <span id="coordinate_info_ij" style="font-family: monospace;">4, 10</span>.
