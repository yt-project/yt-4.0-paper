...
The majority of individuals using `yt` at present are in astronomy and astrophysics, typically fields of simulation, although an increasingly large group of individuals from other domains is participating in development and using `yt` for their own domain-specific problems.
