...
SPH defines field quantities *at* a set of moving points, and field values themselves can be computed by integrating over all the elements in the domain using a special-purpose kernel.
