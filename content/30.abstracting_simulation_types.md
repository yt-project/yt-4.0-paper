...
To do so, the particles merely needed to be converted into a morton index, those index values sorted, and then processed in order to identify the greatest common bit-prefix.
