...
As noted in Section[@sec:data_objects], the process of selecting points is
...
3D vertex-centered data, this would be $(N,8)$. **Andrew Myers: check
this?**
...
(described below in Section[@sec:octree_analysis]).  A spatial tree is
