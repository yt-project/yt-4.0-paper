...
hundreds of files [e.g. @raw:Croft2015]. For even simple analysis tasks, the
...
data each night [@raw:Juric2015a]. In order to analyze such large datasets,
...
@raw:Morton1996; @raw:Hilbert1970]. These partitions have the greatest chance of
...
parallel simulation codes like Gadget-2 [@raw:Springel2005b] and RAMSES
[@raw:Teyssier2001].
...
filling curve [@raw:Morton1996]. This is done by breaking up the domain into
...
[@raw:Hjaltason2002], nearest neighbor searches [@raw:Connor2010], and range
queries [@raw:Orenstein1984]. By recording the indices of the cells
...
[@raw:Wu1998; @raw:Chan1998; @raw:Chan1999]. However, as scientific datasets have
...
[@raw:Malensek2014], earth sciences, rocket science
[@raw:Sinha2006; @raw:Sinha2007], high-energy physics [@raw:Stockinger2000], and
combustion [@raw:Wu2003].
...
[@raw:Yu1998; @raw:Shoshani1999; @raw:Stockinger2004]. Here, Morton indices are used
...
localized regions [@raw:Wu2001; @raw:Lemire2010; @raw:Kaser2016].
...
allowing for multi-resolution indexes [@raw:Sinha2006; @raw:Sinha2007]. Panel
...
@raw:Monaghan1992; @raw:Springel2001; @raw:Springel2005b]. For Morton indices, this
...
[@raw:Springel2001; @raw:Springel2005b; @raw:Hopkins2015].
...
[@raw:Turk20d11a] in order to facilitate the analysis of large astrophysical
...
[@raw:Lemire2010; @raw:Kaser2016] and exposed to Python using Cython
[@raw:Behnel2011].
