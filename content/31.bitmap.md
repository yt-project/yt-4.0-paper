...
Figure [4](#fig:selectors){reference-type="ref"
...
![Dependence of query time (top), fraction of files selected/cells with
...
[\[fig:test\_size\]]{#fig:test_size label="fig:test_size"}
