...
While this is straightforward to implement for grids [@doi:10.1.1.42.3443], in situations where there are overlapping sets of values the process must be handled more carefully.
...
These tables provide a mapping $f(v) \rightarrow u$, where $v$ is a local field value.
...
**Insert transfer function figure here**
