...
While this is straightforward to implement for grids (CITE A&W 1987), in situations where there are overlapping sets of values the process must be handled more carefully.
